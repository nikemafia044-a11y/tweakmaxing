...
| 12 | Release publicada de verdade | `irm "https://tweakmax1ng.vercel.app" \| iex` numa máquina limpa (sem o repositório clonado) | GUI abre normalmente; comparando com o caminho **Verificado** (`Invoke-WebRequest` + `Get-FileHash` contra `SHA256SUMS.txt` publicado na mesma release), o hash bate | |
